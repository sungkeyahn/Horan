...
public class DefaultDataLoader //CoreManager가 단 하나만 가지고 있을 클래스
{
    ...
    public Dictionary<int, Data.DataSet_Upgrade> DataCache_Upgrade { get; private set; } = new Dictionary<int, Data.DataSet_Upgrade>();
    ...
    public void DefaultDataLoad()
    {
        ...
        DataCache_Upgrade = LoadData<Data.Separator_UpgradeTable, int, Data.DataSet_Upgrade>("UpgradeTable").MakeDict();
