...
{
    internal class RimStandardPBRShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent rimText = new GUIContent("Rim", "rim");
            public static GUIContent rimColorText = new GUIContent("Rim Color", "Rim Color (RGB)");
            public static GUIContent rimPowerText = new GUIContent("Rim Power", "the power of the rim effect");
            ...
            public static string rimOptionsText = "Rim Options";
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                GUILayout.Label(Styles.rimOptionsText, EditorStyles.boldLabel);
                DoRimArea(material);
                EditorGUILayout.Space();
