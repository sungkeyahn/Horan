...
#ifndef RIM_UNITY_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
#define RIM_UNITY_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED

#include "Rim_UnityStandardCore.cginc"
...
half4 fragForwardBaseSimpleInternal (VertexOutputBaseSimple i)
{
	...
	half4 outputForwardColor = OutputForward(half4(c, 1), s.alpha);
	...
	half3 mixedColor = outputForwardColor.rgb + rimColor.rgb;

	half4 finalColor = half4(mixedColor, outputForwardColor.a);
...
#endif // RIM_UNITY_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
