...
#ifndef RIM_UNITY_STANDARD_SHADOW_INCLUDED
#define RIM_UNITY_STANDARD_SHADOW_INCLUDED
...
#else
struct VertexOutputShadowCaster_UV
{
	float2 tex : TEXCOORD1;
};
#endif
...
void vertShadowCaster (
	...
	#else
	out VertexOutputShadowCaster_UV o_uv,
    #endif
    ...
    out float4 opos : SV_POSITION)
{
    ...
    TRANSFER_SHADOW_CASTER_NOPOS(o,opos)
        ...
        o.tex = TRANSFORM_TEX(v.uv0, _MainTex);
			...
			o.tex = TRANSFORM_TEX(v.uv0, _MainTex);
		#else
			o_uv.tex = TRANSFORM_TEX(v.uv0, _MainTex);
		#endif
...
#else
	VertexOutputShadowCaster_UV i_uv
#endif
#ifdef UNITY_STANDARD_USE_DITHER_MASK
...
#endif // RIM_UNITY_STANDARD_SHADOW_INCLUDED
